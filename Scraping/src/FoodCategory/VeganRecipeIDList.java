...
public class VeganRecipeIDList {
...
//		String URL = "https://www.tarladalal.com/recipes-for-breakfast--indian-veg-breakfast-recipes-151";
		List<String> urlList = Arrays.asList(
				"https://www.tarladalal.com/recipes-for-vegan-recipes-vegan-diet-1010",
				"https://www.tarladalal.com/recipes-for-vegan-snacks-indian-1011",
				"https://www.tarladalal.com/recipes-for-vegan-salads-1014",
				"https://www.tarladalal.com/recipes-for-vegan-indian-breakfast-1015",
				"https://www.tarladalal.com/recipes-for-vegan-indian-recipes-1017",
				"https://www.tarladalal.com/recipes-for-indian-vegan-recipes-for-kids-1018");

		List<String> urlListOnePage = Arrays.asList(
				"https://www.tarladalal.com/recipes-for-vegan-curries-1012",
				"https://www.tarladalal.com/recipes-for-vegan-soups-1013",
				"https://www.tarladalal.com/recipes-for-vegan-calcium-rich-1016",
				"https://www.tarladalal.com/recipes-for-vegan-desserts-1019",
				"https://www.tarladalal.com/recipes-for-vegan-indian-sweets-and-desserts-1020");
		...
		for(String URL: urlList) {
			...
			String veganSheet = "Vegan"+URL.replaceAll("[^0-9]", "");
			writeColumnByColumn(veganRecipeIDs, veganSheet);
		}
		
		for(String URL: urlListOnePage) {
			System.out.println(URL);
			driver.navigate().to(URL);
	...
	public static void writeColumnByColumn(List<String> finalUrls, String sheetName) throws IOException {		 
		XLUtility xlutil=new XLUtility("./Data/Vegan.xlsx");
